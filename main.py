...
input_data = st.session_state.get("nlp_input_data", sidebar_input)

if "nlp_input_data" in st.session_state:
    st.info("Using natural-language extracted inputs from the AI Health Assistant tab.")
...
# AI Health Assistant (NLP + RAG Chatbot)
